...
extern "C" {
    ...
    static PyObject * Flp_getattr(EdsdkObject * self, char * name);
    static int Flp_setattr(EdsdkObject * self, char * name, PyObject * v);
...
static PyTypeObject Flp_Type = {
    ...
    0,          /*ob_size*/
    "Flp",          /*tp_name*/
    sizeof(EdsdkObject),  /*tp_basicsize*/
    0,          /*tp_itemsize*/
    /* methods */
...
#define EdsdkObject_Check(v) ((v)->ob_type == &Flp_Type)

static EdsdkObject * newEdsdkObject(PyObject * arg)
{
    EdsdkObject * self;
    self = PyObject_NEW(EdsdkObject, &Flp_Type);
    if (self == NULL)
        return NULL;
...
static void Flp_dealloc(EdsdkObject * self)
{
    delete self->flp;
...
static PyObject * Flp_good(EdsdkObject * self, PyObject * args)
{
...
static PyObject * Flp_errorMessage(EdsdkObject * self, PyObject * args)
{
    if (! PyArg_ParseTuple(args, ""))
        return NULL;
...
static PyObject * Flp_tempo(EdsdkObject * self, PyObject * args)
{
    if (! PyArg_ParseTuple(args, ""))
        return NULL;
...
static PyObject * Flp_title(EdsdkObject * self, PyObject * args)
{
    if (! PyArg_ParseTuple(args, ""))
        return NULL;
...
static PyObject * Flp_versionString(EdsdkObject * self, PyObject * args)
{
    if (! PyArg_ParseTuple(args, ""))
        return NULL;
...
static PyObject * Flp_channelCount(EdsdkObject * self, PyObject * args)
{
    if (! PyArg_ParseTuple(args, ""))
        return NULL;
...
static PyObject * Flp_channelName(EdsdkObject * self, PyObject * args)
{
    int i;
...
static PyObject * Flp_channelPluginName(EdsdkObject * self, PyObject * args)
{
    int i;
...
static PyObject * Flp_effectCount(EdsdkObject * self, PyObject * args)
{
    if (! PyArg_ParseTuple(args, ""))
        return NULL;
...
static PyObject * Flp_effectPluginName(EdsdkObject * self, PyObject * args)
{
    int i;
...
static PyObject * Flp_sampleCount(EdsdkObject * self, PyObject * args)
{
    if (! PyArg_ParseTuple(args, ""))
        return NULL;
...
static PyObject * Flp_sampleFileName(EdsdkObject * self, PyObject * args)
{
    int i;
